...
// 오늘의 체험 현황 (키오스크용 - 공개 접근)
router.get('/today', experienceController.getTodayStatus);
...
router.post('/entry',
  ...
  experienceController.recordEntry
);

// 키오스크용 퇴장 처리 (공개 접근)
router.put('/:userId/exit',
  experienceController.recordExit
);
